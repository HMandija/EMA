...
const navItems = [
  ...
  { label: "Analytics", icon: BarChart3, path: `${BASE}/analytics` },
];
  ...
  const Sidebar = () => (
    <div className="flex flex-col h-full bg-zinc-950 border-r border-zinc-800">
      <div className="px-6 py-8 border-b border-zinc-800">
        ...
        <p className="text-zinc-700 text-[8px] uppercase tracking-widest mt-3">
          Admin Panel
        </p>
      </div>
      ...
      <div className="px-3 py-6 border-t border-zinc-800">
        <button
          ...
          className="flex items-center gap-3 px-3 py-2.5 w-full text-[10px] uppercase tracking-wider text-zinc-500 hover:text-red-400 transition-colors"
        >
          <LogOut size={14} />
          Sign Out
        </button>
  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex">
      <div className="hidden md:flex w-56 flex-shrink-0">
        <div className="fixed h-full w-56">
          <Sidebar />
        </div>
      </div>
      {sidebarOpen && (
